...
def add_audio(video_name=None, audio_dir = None):
    ...
    #command = 'ffmpeg -i ' + video_name  + ' -i ' + audio_dir + ' -vcodec copy  -acodec copy -y  ' + video_name.replace('.mp4','_all.mp4')
    command = 'ffmpeg -i ' + video_name  + ' -i ' + audio_dir + ' -y ' + video_name.replace('.mp4','_all.mp4')
    print (command)
    os.system(command)
